...
var coinsdv = Math.floor(Math.random() * 801) + 2000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 401) + 2500; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 601) + 3000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 201) + 3500; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 801) + 4000; //random coins khi đào đá
