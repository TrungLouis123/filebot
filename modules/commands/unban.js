module.exports.config = {
    ...
    hasPermssion: 2,
    credits: "ManhG",
    description: "Gỡ ban nhóm và thằng ngu trong 1 nốt nhạc",
    ...
    switch (s[0]) {
        ...
        case "alluser": {
            ...
            e.sendMessage("Đã gỡ ban cho toàn bộ user trên server", d, o);
            break
        }
        case "qtvall":
        case "Qtvall":
        ...
        case "user":
            if (!s[1]) {
                ...
                return e.sendMessage("Đã gỡ ban cho toàn bộ thằng ngu trong nhóm này!", d, o)
            }
            if (-1 !== s.join().indexOf("@")) {
